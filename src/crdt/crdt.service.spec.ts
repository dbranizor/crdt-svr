...
//     expect(Object.keys(svrSyncResponse.mText.merkleTree)[0]).toBeDefined()
...
//     const svrTree = Object.keys(svr1SyncResponse.mText.merkleTree)[0];
...
//    // expect(Object.keys(svr2SyncResponse.mText.merkleTree)[0]).toEqual(Object.keys(client2Merkle.getTree().getLayersAsObject())[0]);
...
//       mText: {
//         lastSync: nov162019,
//         merkleTree: merkleTree.getTree().getLayersAsObject(),
//         new: [nov17thMessage]
//       }
//     }
